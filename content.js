...
setInterval(function () {
    ...
    EXTENSIONSBOTTOMBAR.innerHTML = "<p style=\"all:unset;margin-left:3px;padding:none;margin-bottom:0px;margin-top:0px;\">" + "<span>" + EXTENSIONCLOCKHOUR + ":" + EXTENSIONCLOCKMINUTE + ":" + EXTENSIONCLOCKSECOND + "</span>" + "<span style=\"color:lightgray\"> | </span>" + "<span>" + (new Date().getMonth() + 1) + "/" + new Date().getDate() + "/" + new Date().getFullYear() + "</span>" + "</p>";
}, 500)