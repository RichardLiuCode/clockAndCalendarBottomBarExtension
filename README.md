...
This is a browser extension that display the current date and time in the bottom right of your browser.
## Features
- Display current time Hour/Minute/Second
- Display current data in the formet Month/Day/Year
